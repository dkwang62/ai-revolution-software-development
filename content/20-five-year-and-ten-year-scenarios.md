...
First, the mathematics is seeking cheaper memory. The Transformer became powerful partly because **attention** lets a model compare different parts of an input. Ordinary attention, however, becomes expensive as the input grows. **State-space models** such as Mamba and memory research such as Google's Titans point towards hybrid systems in which attention works alongside recurrence, persistent memory, specialised models, tools, and extra computation for difficult questions. This does not prove that the Transformer will disappear. It suggests that it may be absorbed into a larger system. [Gu and Dao, _Mamba_](https://arxiv.org/abs/2312.00752); [Behrouz, Zhong and Mirrokni, _Titans_](https://research.google/pubs/titans-learning-to-memorize-at-test-time/)
...
Third, the AI computer is becoming a coordinated system. Processors are useful only if enormous quantities of data can reach them quickly. High-bandwidth memory, chiplets, faster links, custom accelerators, and shorter numerical formats such as **FP4** all reduce movement and calculation. Manufacturers now describe complete platforms combining processors, networking, memory, and storage—not simply one faster chip. [Micron, “HBM4”](https://www.micron.com/products/memory/hbm/hbm4); [NVIDIA, “Rubin”](https://nvidianews.nvidia.com/news/rubin-platform-ai-supercomputer)
