...
Writing repetitive supporting code may become less valuable. Looking up the exact writing rules of a programming language may matter less. AI may increasingly automate ordinary screens for creating, reading, changing, and deleting records—the four operations programmers abbreviate as **CRUD**—along with simple scripts, standard tests, settings, and common connections between systems.
...
The evidence is moving. In [February 2026](https://metr.org/blog/2026-02-24-uplift-update/), METR said the early result no longer represented current tools. Its late-2025 data suggested possible speedups, but participant selection and unreliable time measurement made the size highly uncertain. Google's DevOps Research and Assessment programme, known as **DORA**, associated greater AI adoption with lower delivery speed and stability in its [2024 report](https://dora.dev/research/2024/dora-report/); its [2025 research](https://dora.dev/research/2025/dora-report/) found higher speed alongside continued instability. These findings are not contradictions that can be averaged into one productivity number. A short task, work inside a familiar project, a developer survey, and organisation-wide delivery records measure different things. The question is always: faster at which task, for whom, under what quality standard, and with what downstream cost?
